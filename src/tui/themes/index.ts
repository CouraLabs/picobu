...
import rosePineDawn from "@tui/themes/assets/rose-pine-dawn.json" with { type: "json" }
...
import doomOne from "@tui/themes/assets/doom-one.json" with { type: "json" }
import vitesseDarker from "@tui/themes/assets/vitesse-darker.json" with { type: "json" }
import vitesse from "@tui/themes/assets/vitesse.json" with { type: "json" }
import horizonDarker from "@tui/themes/assets/horizon-darker.json" with { type: "json" }
...
import catppuccinFrappe from "@tui/themes/assets/catppuccin-frappe.json" with { type: "json" }
import catppuccinMacchiato from "@tui/themes/assets/catppuccin-macchiato.json" with { type: "json" }
...
import lucentOrng from "@tui/themes/assets/lucent-orng.json" with { type: "json" }
...
import rosepine from "@tui/themes/assets/rosepine.json" with { type: "json" }
...
import tokyonight from "@tui/themes/assets/tokyonight.json" with { type: "json" }

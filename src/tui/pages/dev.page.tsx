...
import { indexOfTheme, setTheme, themeInfo, themeOptions, themes } from '@states/theme-state.ts'
...
export const DevPage = () => {
  return (
    <box flexDirection={'column'} gap={1}>
      ...
      <Dropdown options={themeOptions} onSelect={(option) => setTheme(String(option.value), themeInfo().variant)} selected={indexOfTheme(themes)} placeholder="Select theme…" maxWidth={24} />
      <Button
        label="Open dialog"
        onClick={() =>
          openDialog(() => (

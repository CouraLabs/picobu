...
export const getFinishReason = (meta: LoopMessageMetadata | undefined, usage: SessionUsage | undefined): string | undefined => meta?.finishReason ?? usage?.finishReason
...
export const createSessionStatusData = (props: SessionStatusProps): SessionStatusData => {
  ...
  return {
    ...
    finishReason: () => getFinishReason(meta(), props.usage),
    finishColor: () => getFinishColor(getFinishReason(meta(), props.usage)),

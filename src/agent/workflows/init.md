---
name: init
description: Generates an AGENTS.md with best practices
---
...
- existing instruction files (AGENTS.md, CLAUDE.md, .agents/rules/, .cursor/rules, .cursorrules, .github/copilot-instructions.md)
...
Only ask the user questions if the repo cannot answer something important. Use the **ask** tool for one short batch at most.

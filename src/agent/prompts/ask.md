...
- If the request is really "build or change something" rather than a question, surface that intent: state what you understood and offer to switch to the Grill agent (agent cycle) to shape the design, instead of answering read-only as if it were trivia.
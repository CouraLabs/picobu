...
- `src/hooks/` — `useRunMetrics`, `useLoopKeybinds` (swallows all keys mid-stream), `useGitStatus`, `useClipboard`/`usePromptClipboard`, `useCopyToClipboard` (OSC 52), `useCopyableMessage`, `useSession`, `useRunCompletionNotification`.
